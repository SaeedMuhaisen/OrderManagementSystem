...
import { IconHome, IconProduct, IconReceipt, IconStore } from "../../../../Features/Common/components/svg/Icons";
...
const SellerSideBar = ({ dispatch }) => {
    ...
    return (
        <div className="sidebar-container">
            <nav >
                <div className="sidebar-buttonsList">
                    <SideBarButton setActive={setActive} active={active} title={"Home"} navigateTo="/seller/home" icon={<IconHome />} />
